...
- The shell you are currently using has not loaded the updated profile, either - close the terminal shell and open a new one - `source` the updated profile (e.g. `source ~/.zshrc`)
